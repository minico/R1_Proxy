...
class DataUtil
{
    ...
    public function generateCodeBody() {
        $this->httpInfo['body'] = '{"code":"ANSWER","originIntent":{"nluSlotInfos":[]},"history":"cn.yunzhisheng.chat","source":"krc","uniCarRet":{"result":[],"returnCode":609,"message":"http post reuqest error"},"asr_recongize":"12345。","rc":0,"general":{"resourceId":"bdzd_123_3693158","style":"CQA_baidu_zhidao","text":"上山打老虎"},"returnCode":0,"audioUrl":"http://asrv3.hivoice.cn/trafficRouter/r/YZvVpq","retTag":"nlu","service":"cn.yunzhisheng.chat","nluProcessTime":"320","text":"12345","responseId":"dc950b037aa24edbb35d6a89dc74c8ea"}';
    }

   /* public function generateSemanticBody() {
        $this->httpInfo['body'] = '{"semantic":{"intent":{"artist":"游鸿明","keyword":"游鸿明"}},"code":"SEARCH_CATEGORY","data":{"result":{"count":1,"musicinfo":[{"id":4384379,"errorCode":0,"duration":3511309,"lyric":"","album":"","title":"游鸿明3","artist":"游鸿明","hdImgUrl":"","isCollected":false,"url":"http://nas.ku8.fun:8888/music/./MP3/游鸿明 - 下沙.mp3"}],"totalTime":10,"pagesize":1,"errorCode":0,"page":"1","source":1,"dataSourceName":"我的音乐"}},"originIntent":{"nluSlotInfos":[]},"history":"cn.yunzhisheng.music","source":"nlu","uniCarRet":{"result":[],"returnCode":609,"message":"aios-home.hivoice.cn"},"asr_recongize":"游鸿明","rc":0,"general":{"actionAble":"true","quitDialog":"true","text":"游鸿明","type":"T"},"returnCode":0,"audioUrl":"http://asrv3.hivoice.cn/trafficRouter/r/wMgclE","retTag":"nlu","service":"cn.yunzhisheng.music","nluProcessTime":"106","text":"游鸿明","responseId":"e490d9576c5b438c8283a6e71cdba997"}'
   }*/
